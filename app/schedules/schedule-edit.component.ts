...
export class ScheduleEditComponent implements OnInit {
    ...
    loadScheduleDetails() {
        this.dataService.getScheduleDetails(this.id)
            .subscribe((schedule: IScheduleDetails) => {
                    ...
                    this.schedule.timeStart = new Date(this.schedule.timeStart.toString());
                    this.schedule.timeEnd = new Date(this.schedule.timeEnd.toString());
    ...
    updateSchedule(editScheduleForm: NgForm) {
        ...
        let scheduleMapped = this.mappingService.mapScheduleDetailsToSchedule(this.schedule);
